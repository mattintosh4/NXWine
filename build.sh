...
patch_wine_common_ver ()
{
  patch ${workroot}/wine/include/wine/wine_common_ver.rc <<\EOS
@@ -100,7 +100,7 @@
 {
...
patch_wine_timezone ()
{
  patch ${workroot}/wine/tools/wine.inf.in <<\EOS
@@ -637,8 +637,6 @@
...
@@ -2747,10 +2745,6 @@
 ...
 HKLM,%CurrentVersionNT%\Time Zones\Jordan Standard Time,"TZI",1,88,ff,ff,ff,00,00,00,00,c4,ff,ff,ff,00,00,0a,00,05,00,05,00,01,00,00,00,00,00,00,00,00,00,03,00,04,00,05,00,00,00,00,00,00,00,00,00
...
-HKLM,%CurrentVersionNT%\Time Zones\Korea Standard Time,"TZI",1,e4,fd,ff,ff,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00
 HKLM,%CurrentVersionNT%\Time Zones\Mexico Standard Time,"Display",,"America/Mexico_City"
 HKLM,%CurrentVersionNT%\Time Zones\Mexico Standard Time,"Dlt",,"Mexico Daylight Time"
 HKLM,%CurrentVersionNT%\Time Zones\Mexico Standard Time,"Std",,"Mexico Standard Time"
EOS
}

patch_wine_iexpre_main ()
{
  patch ${workroot}/wine/programs/iexplore/main.c <<\EOS
@@ -40,7 +40,7 @@
